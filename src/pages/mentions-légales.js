        ...
        <div className="row d-flex justify-content-center">
          <div className="col-lg-6 col-xl-6 col-md-12 mx-auto">
            ...
            <p className="legal-statement">
              ...
              responsables du présent site internet www.rosah-jeunesse.re sont :
            </p>
            ...
            <p>
              Le site est hébergé par Netlify Inc., dont le siège social est
              situé à 2325 3rd Street, Suite 296, San Francisco, California
              94107.
            </p>
            <p className="mt-2 mb-2">Développement :</p>
            <p>Stéphane Fok yin</p>
            <p>adresse e-mail: stephanefokyin@gmail.com</p>
            <h4 className="mt-3">Conditions d'utilisation :</h4>
            <p className="legal-statement">
              Ce site (www.rosah-jeunesse.re) est proposé en différents langages
            ...
            <p className="legal-statement">
              L’éditeur met en œuvre tous les moyens dont elle dispose, pour
            ...
            <p className="legal-statement">
              ...
              devra donc s’assurer de l’exactitude des informations auprès de
              l'éditeur, et signaler toutes modifications du site qu’il jugerait
              utile. AntheDesign n’est en aucun cas responsable de l’utilisation
            ...
            <h4 className="mt-3">Liens hypertexte: </h4>
            <p className="legal-statement">
              Ce site (www.rosah-jeunesse.re) peut offrir des liens vers
              d’autres sites internet ou d’autres ressources disponibles sur
              Internet. www.rosah-jeunesse.re ne dispose d’aucun moyen pour
              contrôler les sites en connexion avec ses sites internet.
            </p>
            <p className="legal-statement">
              Ce site (www.rosah-jeunesse.re) ne répond pas de la disponibilité
            ...
            <p className="legal-statement">
              Les visiteurs de ce site internet ne peuvent pas mettre en place
              un hyperlien en direction de ce site sans l’autorisation expresse
              et préalable de l'éditeur.
            </p>
            <p className="legal-statement">
              ...
              l'éditeur, il lui appartiendra d’adresser un email accessible sur
              le site afin de formuler sa demande de mise en place d’un
              hyperlien.
            </p>
            <p className="legal-statement">
              L'éditeur se réserve le droit d’accepter ou de refuser un
            ...
            <p className="legal-statement">
              ...
              à l’adresse contact@rosahjeunesse.re, en décrivant le problème de
            ...
            <h4 className="mt-3">Propriété intellectuelle :</h4>
            <p className="legal-statement">
              Tout le contenu du présent site www.rosah-jeunesse.re, incluant,
              de façon non limitative, les graphismes, images, textes, vidéos,
              animations, sons, logos, gifs et icônes sont la propriété
              exclusive de ©2022 Jeunesse Global Holdings, LLC. Tous Droits
              Réservés. Leur mise en forme est la propriété de l'éditeur à
            ...
            <p className="legal-statement">
              ...
              de l'éditeur. Cette représentation ou reproduction, par quelque
            ...
            <h4 className="mt-3">Litiges :</h4>
            <p className="legal-statement">
              Les présentes conditions du site www.rosah-jeunesse.re sont régies
            ...
            <h4 className="mt-3">Données personnelles :</h4>
            <p className="legal-statement">
            ...
            <p className="legal-statement">
              ...
              vous remplissez le formulaire qui vous est proposé en ligne, dans
              la rubrique « contact ».
            </p>
            <p className="legal-statement">
              Dans tous les cas, vous pouvez refuser de fournir vos données
              personnelles. Dans ce cas, vous ne pourrez pas utiliser les
              services du site, notamment celui de solliciter des renseignements
              sur notre site, ou de recevoir les lettres d’information.
            </p>
            <p className="legal-statement">
